...
Book::Book(const std::string &title, const std::string &author,
           int releaseYear, int pageNumber, int coverWeight) : _title(title), _author(author), _releaseYear(releaseYear),
                                                               _pageNumber(pageNumber), _weight(10 * pageNumber + coverWeight)
{}
